    ...
    public class ObjectivePointer : MonoBehaviour
    {
        ...
        public void Subscribe(ObjectiveHandler handler)
        {
            handler.Events.Subscribe<ObjectiveHandler, ObjectiveElement>
                (ObjectiveHandler.EventTypes.Created, (a, b) => CheckTrack(handler.Current));

            handler.Events.Subscribe<ObjectiveElement, ObjectiveTracking?>
                (ObjectiveHandler.EventTypes.TrackModified, (a, b) => CheckTrack(handler.Current));

            handler.Events.Subscribe<ObjectiveHandler, ObjectiveElement>
                (ObjectiveHandler.EventTypes.Removed, (a, b) => CheckTrack(handler.Current));
        ...
        private void Track(ObjectiveTracking? track)
        {
            if (!track.HasValue)
            {
